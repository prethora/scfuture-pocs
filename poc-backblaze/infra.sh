...
# ─── Backblaze B2 Backup & Restore PoC — Hetzner Cloud Infrastructure ───
# Manages two CX23 servers with a private network.
...
# Resource names
SSH_KEY_NAME="b2-poc-key"
NETWORK_NAME="poc-backblaze-net"
SERVER1_NAME="poc-b2-machine-1"
SERVER2_NAME="poc-b2-machine-2"
SERVER_TYPE="cx23"
...
cmd_up() {
    ...
    # 6. Save state
    cat > "$INFRA_ENV" << EOF
# Backblaze B2 PoC — Infrastructure State
...
EOF
    ...
    echo ""
    info "Cloud-init is provisioning packages. This takes ~3-4 minutes."
